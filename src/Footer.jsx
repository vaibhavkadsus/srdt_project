      ...
      <div className="container text-center text-md-left">
        <div className="row text-center text-md-left">
          ...
          <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p>A Step Towards Social Change — empowering lives through sustainable development and education.</p>
          </div>
          ...
          <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p><i className="fas fa-home me-3"></i> Ahmednagar, Maharashtra, India</p>
            <p><i className="fas fa-envelope me-3"></i> info@srdt.org</p>
